...
public class ImageDownloader {
	...
	public interface ImageExtender {
		void saveImage(String url, Bitmap image);
	}
	
    private static final String LOG_TAG = "ImageDownloader";  
    public enum Mode { NO_ASYNC_TASK, NO_DOWNLOADED_DRAWABLE, NO_DOWNLOADED_DRAWABLE_WITHOUT_IMAGEVIEW, CORRECT }
    private Mode mode = Mode.CORRECT;
    private ImageExtender _ie;
    
    public ImageDownloader(ImageExtender ie){
    	this._ie = ie;
    }
